...
// Дефолтные заголовки секций (надзаголовок/заголовок/подпись). Редактируются в
// админке (/admin/sections) ключами <id>_eyebrow / <id>_title / <id>_subtitle;
// пусто = эти дефолты. В title поддерживается **акцент** (renderAccent).
// Единый источник для компонентов (SectionHead и т.п.) и формы админки.
export type SectionIntro = { eyebrow: string; title: string; subtitle?: string };

export const sectionIntros: Record<string, SectionIntro> = {
  projects: {
    eyebrow: "Каталог проектов",
    title: "Проекты 80-140 м² для своего или подобранного участка",
    subtitle:
      "Готовые решения можно адаптировать под ваш участок, фасад, планировку и ипотечный бюджет.",
  },
  prices: {
    eyebrow: "Комплектации и цены",
    title: "Выберите **комплектацию**",
    subtitle: "Три формата строительства — от тёплого контура до дома под ключ.",
  },
  homes: {
    eyebrow: "Готовые дома",
    title: "Объекты, которые можно посмотреть вживую",
    subtitle:
      "Выберите готовый дом с участком, коммуникациями и понятными условиями покупки.",
  },
  building: {
    eyebrow: "Дома в строительстве",
    title: "Объекты, которые можно забронировать до сдачи",
    subtitle:
      "Дома на разных этапах готовности: можно посмотреть ход строительства, уточнить срок сдачи и условия бронирования.",
  },
  plots: {
    eyebrow: "Участки под строительство",
    title: "Земля под дом **без отдельного поиска**",
    subtitle:
      "Предложим участок и проект дома, который можно разместить с учетом площади, подъезда и коммуникаций.",
  },
  built: {
    eyebrow: "Построенные объекты",
    title: "Дома, которые мы уже сдали",
    subtitle: "Реальные объекты нашей компании — от фундамента до сдачи под ключ.",
  },
  payment: {
    eyebrow: "Ипотека и рассрочка",
    title: "Дом в ипотеку **от 5,9%** или рассрочка от компании",
    subtitle:
      "Аккредитованы в крупных банках — поможем подобрать программу и собрать документы.",
  },
  process: {
    eyebrow: "Как мы работаем",
    title: "Этапы строительства — от проекта до сдачи",
  },
  trust: {
    eyebrow: "Доверие",
    title: "Доверие строится на прозрачности",
    subtitle: "До сделки вы видите объекты, смету, договор, этапы работ и условия оплаты.",
  },
  reviews: {
    eyebrow: "Отзывы покупателей",
    title: "Что говорят те, кто уже построил с нами",
    subtitle: "Живые скриншоты отзывов и переписок — листайте вправо.",
  },
  contacts: {
    eyebrow: "Контакты",
    title: "Подберем дом, проект или участок под ваш бюджет",
    subtitle:
      "Оставьте телефон, и мы предложим ближайший вариант для просмотра или расчета.",
  },
};
